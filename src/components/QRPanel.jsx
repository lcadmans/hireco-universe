...
export function QRPanel() {
	...
	return (
		<div className={`custom-loader pointer-events-none absolute  z-[60]  flex h-full w-full items-center justify-end  pr-[20vw]  transition-all delay-[200ms] duration-[800ms] ease-in-out`}>
